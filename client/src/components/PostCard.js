...
export default function PostCard({
  ...
  return (
    ...
    >
      ...
      <Link
        to={`post/${slug}`}
        className="text-white bg-gradient-to-r from-neutral-500 to-neutral-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 shadow"
      >
        Read More
      </Link>
    </div>
